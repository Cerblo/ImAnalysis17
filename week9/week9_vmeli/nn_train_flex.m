function weigths= nn_train_flex( x, t, lrate,nb_iter, nb_neurons )
...
for l=1:nb_hl
            weigths(l+1).layer=l;
            weigths(l+1).w=rand(nb_neurons_full(1,l),nb_neurons_full(1,l+1));
            weigths(l).b=rand(1,nb_neurons_full(1,l+1));
end
...
for iter=1:nb_iter
    ...
    weigths(nb_hl+1).w = weigths(nb_hl+1).w - lrate*weigths(nb_hl).z'*weigths(nb_hl+1).delta ;
    ...
    for l=1:nb_hl-1
        ...
        weigths(nb_hl-l+1).w = weigths(nb_hl-l+1).w - lrate*weigths(nb_hl-l).z'*weigths(nb_hl-l+1).delta ;
    end 
